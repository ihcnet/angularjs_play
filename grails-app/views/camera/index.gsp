...
<html>
    ...
    <body data-ng-app="scaffolding" data-base-url="${createLink(uri: '/camera/')}">
        <a href="#list-camera" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
