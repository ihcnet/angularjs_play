...
<%@ page import="com.demo.Display" %>
<!doctype html>
<html>
    <head>
        <meta name="layout" content="ng-app">
        <g:set var="entityName" value="${message(code: 'display.label', default: 'Display')}" />
    ...
    <body data-ng-app="scaffolding" data-base-url="${createLink(uri: '/display/')}">
        <a href="#list-display" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
