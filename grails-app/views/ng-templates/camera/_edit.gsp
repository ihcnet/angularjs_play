...
<g:set var="CameraSubPrefix" value="${subPrefix ? subPrefix + '.' : ''}"/>
    ...
    <g:render template="/ng-templates/feature/hasManyList" model="[subPrefix: CameraSubPrefix + 'features']" /><g:render template="/ng-templates/feature/edit" model="[subPrefix: CameraSubPrefix + 'features']" />
