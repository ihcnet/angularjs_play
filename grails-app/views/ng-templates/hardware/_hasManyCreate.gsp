...
<div class="control-group" data-ng-class="{error: errors.${HardwareSubPrefix}accelerometer}">
    ...
    <div class="controls">
        <input type="checkbox" id="accelerometer" name="accelerometer" data-ng-model="${HardwareSubPrefix}accelerometer">
...
<div class="control-group" data-ng-class="{error: errors.${HardwareSubPrefix}audioJack}">
    ...
    <div class="controls">
        <input type="text" id="audioJack" name="audioJack" data-ng-model="${HardwareSubPrefix}audioJack">
...
<div class="control-group" data-ng-class="{error: errors.${HardwareSubPrefix}cpu}">
    ...
    <div class="controls">
        <input type="text" id="cpu" name="cpu" data-ng-model="${HardwareSubPrefix}cpu">
...
<div class="control-group" data-ng-class="{error: errors.${HardwareSubPrefix}fmRadio}">
    ...
    <div class="controls">
        <input type="checkbox" id="fmRadio" name="fmRadio" data-ng-model="${HardwareSubPrefix}fmRadio">
...
<div class="control-group" data-ng-class="{error: errors.${HardwareSubPrefix}physicalKeyboard}">
    ...
    <div class="controls">
        <input type="checkbox" id="physicalKeyboard" name="physicalKeyboard" data-ng-model="${HardwareSubPrefix}physicalKeyboard">
...
<div class="control-group" data-ng-class="{error: errors.${HardwareSubPrefix}usb}">
    ...
    <div class="controls">
        <input type="text" id="usb" name="usb" data-ng-model="${HardwareSubPrefix}usb">
