...
<%@ page import="com.demo.Battery" %>
<!doctype html>
<html>
    <head>
        <meta name="layout" content="ng-app">
        <g:set var="entityName" value="${message(code: 'battery.label', default: 'Battery')}" />
    ...
    <body data-ng-app="scaffolding" data-base-url="${createLink(uri: '/battery/')}">
        <a href="#list-battery" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
