...
<%@ page import="com.demo.Connectivity" %>
<!doctype html>
<html>
    <head>
        <meta name="layout" content="ng-app">
        <g:set var="entityName" value="${message(code: 'connectivity.label', default: 'Connectivity')}" />
    ...
    <body data-ng-app="scaffolding" data-base-url="${createLink(uri: '/connectivity/')}">
        <a href="#list-connectivity" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
